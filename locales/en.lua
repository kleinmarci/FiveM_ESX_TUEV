Locales['en'] = {
  ...
  -- Armory
  ['quantity'] = 'Verbrauchs Gegenstände',
  ['quantity_invalid'] = '~r~Nicht genug Gegenstände davon~s~',
  ['have_withdrawn'] = 'Du hast Rausgenommen ~y~%sx~s~ ~b~%s~s~',
  ['have_deposited'] = 'Du hast Eingelagert ~y~%sx~s~ ~b~%s~s~',
  ['get_weapon'] = 'Waffen holen',
  ['put_weapon'] = 'Waffen bringen',
  ['buy_weapons'] = 'Waffen kaufen',
  ['deposit_object'] = '~g~Gegenstand eingelagert~s~',
  ['remove_object'] = 'Gegenstand rausgenommen',
  ['ballas_stock'] = 'Verbrauchs Gegenstände',
  ['inventory'] = 'Gegenstände einlagern',
  ['added'] = '~g~Gegenstand eingelagert ',
  ['armory'] = 'Waffenkammer',
